...
def run():
    ...
    while game:
        ...
        #bot.move_images()
        hero.move_images()
        #pyinstaller --onefile --noconsole --windowed main.py -p data.py -p classes.py --hidden-import os --hidden-import random --hidden-import pygame --hidden-import time --add-data "image;image"
        #hero
